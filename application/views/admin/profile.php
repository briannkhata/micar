        ...
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <?php } ?>
                    <?php foreach($this->M_user->get_user_by_id($this->session->userdata('user_id')) as $pro){?>
                    <form class="form-horizontal form-bordered" action="<?=base_url();?>User/save" method="post">
                            ...
                            <div class="col-lg-2">
                                <select class="form-control" name="role">
                                    <option selected disabled>Role</option>
                                        <option <?php if($pro['role'] == 'admin') echo 'selected';?> value="admin">Administrator</option>
                                        <option <?php if($pro['role'] == 'seller') echo 'selected';?> value="seller">Seller</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-lg-6">
                                <textarea rows="" cols=""
                                    class="form-control" name="address"><?=$pro['address'];?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-lg-2">
                                <select class="form-control" name="district_id">
                                    ...
                                    <option <?php if($pro['district_id'] == $row['district_id']) echo 'selected';?>
