        ...
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <?php } ?>
                <?php foreach($this->M_car->get_car_by_id($car_id) as $det){
                    $user_id = $this->M_car->get_user_id($car_id);
                    $name = $this->M_user->get_name($user_id);
                    $phone = $this->M_user->get_phone($user_id);
                    $email = $this->M_user->get_email($user_id);
                    ?>
