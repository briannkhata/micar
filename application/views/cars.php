            ...
            <div class="col-lg-3 col-md-4">
                <div class="listing-sidebar">
                    ...
                    <div class="widget-banner">
                        <img class="img-fluid center-block" src="<?=base_url();?>dist/images/banner.jpg" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                            <div class="car-item gray-bg text-center">
                                <div class="car-image">
                                    <img class="img-fluid" src="<?=base_url();?>dist/images/car/01.jpg" alt="">
