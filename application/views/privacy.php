        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p> eum nihil expedita dolorum odio dolorem, explicabo rem illum magni perferendis. You will begin to
                    ...
                    magni perferendis.</p>
                <p>You will begin to realize why, consectetur adipisicing elit. Quidem error quae illo excepturi nostrum
                    blanditiis laboriosam magnam explicabo. Molestias, eum nihil expedita dolorum odio dolorem,
                    explicabo rem illum magni perferendis.</p>

                <h5 class="text-red">Personal Information</h5>
                <ul class="list-style-1">
                    <li> <i class="fa fa-angle-right"></i> You will begin to realize why, consectetur </li>
                    <li> <i class="fa fa-angle-right"></i> Quidem error quae illo excepturi nostrum blanditiis
                        laboriosam </li>
                ...
                <p>You will begin to realize why, consectetur adipisicing elit. Possimus, ex, quisquam. Nulla excepturi
                    ...
                    quisquam. Nulla excepturi sint iusto incidunt sed omnis expedita, commodi dolores. Debitis nemo
                    animi quia deleniti commodi nesciunt illo. Deserunt.You will begin to realize why, consectetur
                    adipisicing elit. Possimus, ex, quisquam. Nulla excepturi sint iusto incidunt sed omnis expedita,
                    commodi dolores. Debitis nemo animi quia deleniti commodi nesciunt illo. Deserunt.</p>

                <h5 class="text-red">Disclosure of User Information.</h5>
                <p>You will begin to realize why, consectetur adipisicing elit. Autem ullam nostrum dolor alias
                    aspernatur nobis suscipit eaque cumque distinctio eos, beatae deserunt, nihil nam maiores vero, eius
                    harum. Reprehenderit, aspernatur.<a href="#">support@website.com</a> </p>
                ...
                <p class="mb-0">You will begin to realize why, consectetur adipisicing elit. Possimus, ex, quisquam.
                    Nulla excepturi sint iusto incidunt sed omnis expedita, commodi dolores. Debitis nemo animi quia
                    deleniti commodi nesciunt illo. Deserunt.<a href="#">support@website.com</a></p>
            </div>
        </div>
    </div>
</section>
