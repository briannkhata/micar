...
<head>
    ...
    <!-- Specific Page <?=base_url();?>backend/vendor CSS -->
    ...
    <script src="<?=base_url();?>backend/master/style-switcher/style.switcher.localstorage.js"></script>
</head>
...
<body>
    <section class="body">
        ...
        <header class="header">
            <div class="logo-container">
                <a href="https://www.okler.net/previews/porto-admin/4.1.0" class="logo"> <img src="<?=base_url();?>backend/img/logo.png"
                        width="75" height="35" alt="Porto Admin" />
                </a>
                ...
                <div id="userbox" class="userbox">
                    <a href="#" data-bs-toggle="dropdown">
                        <figure class="profile-picture">
                            <img src="<?=base_url();?>backend/img/logged-user.jpg" alt="Joseph Doe" class="rounded-circle"
                                data-lock-picture="<?=base_url();?>backend/img/logged-user.jpg" />
                        </figure>
                        <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                            <span class="name"><?=$this->session->userdata('name');?></span>
                            <span class="role"><?=$this->session->userdata('account_type');?></span>
                        </div>
                    ...
                    <div class="dropdown-menu">
                        <ul class="list-unstyled mb-2">
                            ...
                            <li>
                                <a role="menuitem" tabindex="-1" href="<?=base_url();?>Login/logout"><i
                                            ...
                                            <div id="collapse1Two" class="accordion-body collapse">
                                                <div class="card-body">
                                                    <ul class="simple-user-list mb-3">
                                                        ...
                                                        <li>
                                                            <figure class="image rounded">
                                                                <img src="img/%21sample-user.jpg" alt="Joe Junior"
                                                                    class="rounded-circle">
                                                            </figure>
    ...
    <!-- <?=base_url();?>backend/vendor -->
    <script src="<?=base_url();?>backend/vendor/jquery/jquery.js"></script>
    <script src="<?=base_url();?>backend/vendor/jquery-browser-mobile/jquery.browser.mobile.js"></script>
    <script src="<?=base_url();?>backend/vendor/jquery-cookie/jquery.cookie.js"></script>
    <script src="master/style-switcher/style.switcher.js"></script>
    <script src="<?=base_url();?>backend/vendor/popper/umd/popper.min.js"></script>
    <script src="<?=base_url();?>backend/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?=base_url();?>backend/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    <script src="<?=base_url();?>backend/vendor/common/common.js"></script>
    <script src="<?=base_url();?>backend/vendor/nanoscroller/nanoscroller.js"></script>
    <script src="<?=base_url();?>backend/vendor/magnific-popup/jquery.magnific-popup.js"></script>
    <script src="<?=base_url();?>backend/vendor/jquery-placeholder/jquery.placeholder.js"></script>
    <!-- Specific Page <?=base_url();?>backend/vendor -->
    <script src="<?=base_url();?>backend/vendor/jquery-ui/jquery-ui.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqueryui-touch-punch/jquery.ui.touch-punch.js"></script>
    <script src="<?=base_url();?>backend/vendor/jquery-appear/jquery.appear.js"></script>
    <script src="<?=base_url();?>backend/vendor/bootstrap-multiselect/js/bootstrap-multiselect.js"></script>
    <script src="<?=base_url();?>backend/vendor/jquery.easy-pie-chart/jquery.easypiechart.js"></script>
    <script src="<?=base_url();?>backend/vendor/flot/jquery.flot.js"></script>
    <script src="<?=base_url();?>backend/vendor/flot.tooltip/jquery.flot.tooltip.js"></script>
    <script src="<?=base_url();?>backend/vendor/flot/jquery.flot.pie.js"></script>
    <script src="<?=base_url();?>backend/vendor/flot/jquery.flot.categories.js"></script>
    <script src="<?=base_url();?>backend/vendor/flot/jquery.flot.resize.js"></script>
    <script src="<?=base_url();?>backend/vendor/jquery-sparkline/jquery.sparkline.js"></script>
    <script src="<?=base_url();?>backend/vendor/raphael/raphael.js"></script>
    <script src="<?=base_url();?>backend/vendor/morris/morris.js"></script>
    <script src="<?=base_url();?>backend/vendor/gauge/gauge.js"></script>
    <script src="<?=base_url();?>backend/vendor/snap.svg/snap.svg.js"></script>
    <script src="<?=base_url();?>backend/vendor/liquid-meter/liquid.meter.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/jquery.vmap.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/data/jquery.vmap.sampledata.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/jquery.vmap.world.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/continents/jquery.vmap.africa.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/continents/jquery.vmap.asia.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/continents/jquery.vmap.australia.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/continents/jquery.vmap.europe.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js"></script>
    <script src="<?=base_url();?>backend/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js"></script>
    <!-- Theme Base, Components and Settings -->
    <script src="<?=base_url();?>backend/js/theme.js"></script>
    <!-- Theme Custom -->
    <script src="<?=base_url();?>backend/js/custom.js"></script>
    <!-- Theme Initialization Files -->
    <script src="<?=base_url();?>backend/js/theme.init.js"></script>
    ...
    <!-- Examples -->
    <script src="<?=base_url();?>backend/js/examples/examples.dashboard.js"></script>
</body>
